...
import 'dart:io';
import 'package:admin_grocery_app/widgets/button_widget.dart';
...
class EditProductScreen extends StatefulWidget {
  ...
  static const String routeName = '/editProdScreen';
...
class _EditProductScreenState extends State<EditProductScreen> {
    ...
    if(isValid){
      ...
      try{
        ...
        if(_pickedImage != null){
          ...
          final ref = FirebaseStorage.instance.ref().child('userImages').child('${widget.id}.jpg');
          if (kIsWeb) {
        ...
        await FirebaseFirestore.instance.collection('products').doc(widget.id).update(
          ...
          ToastMsg.toastMsg(msg: 'Updated Data');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
    //  key: context.read<MenuControllerProvider>().getEditsScaffoldKey,
          ...
          child: Center(
            child: Column(
              ...
              children: [
                // Header(
                //   onTap:(){
                //     context.read<MenuControllerProvider>().controlEditScreen();
                //   }, title: 'Edit Screen',
                //
                // ),
                Container(
